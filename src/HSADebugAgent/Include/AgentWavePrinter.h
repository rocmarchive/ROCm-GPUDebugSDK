...
//==============================================================================
#ifndef AGENT_WAVEPRINTER_H_
#define AGENT_WAVEPRINTER_H_
...
private:
    ...
    /// Key for the wave info buffer shared memory
    int m_waveBufferShmKey;

    /// Max size for the wave info buffer shared memory
    size_t m_waveBufferMaxSize;
