...
//==============================================================================
#ifndef AGENT_FOCUS_CONTROL_H_
#define AGENT_FOCUS_CONTROL_H_
...
public:
    AgentFocusWaveControl():
        m_focusWorkGroup(gs_UNKNOWN_HWDBGDIM3),
        m_focusWorkItem(gs_UNKNOWN_HWDBGDIM3)
    {
